...
public class FastLeaderElection implements Election {
    ...
    protected class Messenger {
        ...
        void start(){
            /**
             * 启动业务层发送线程，将消息发送给IO负责类，QuorumCnxManager
             */
            this.wsThread.start();
            /**
            ...
            while ((self.getPeerState() == ServerState.LOOKING) &&
                ...
                if(n == null){
                    ...
                    case LOOKING:
                        ...
                        /**
                         * 判断接收到的节点epoch 大于logicalclock,则表示当前是新一轮的选举
                         */
                        if (n.electionEpoch > logicalclock.get()) {
                            ...
                            recvset.clear();
                            /**
                             * 检查接收到的这个消息是否可以胜出，一次比较epoch,zxid,myid
                             */
                        ...
                        break;
                    /**
                     * 如果收到的消息选票状态不是LOOKING,比如这台机器刚加入一个已经正在运行的ZK集群时
                     * observer 不参与选举
                     */
                    case OBSERVING:
